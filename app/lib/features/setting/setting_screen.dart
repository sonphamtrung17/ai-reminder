              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => context.router.push(const SettingProfileScreen()),
                  ),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  SettingMenuItem(
                    leading: Image.asset(
                      Assets.icons.icGTranslate.path,
                      width: 22,
                      height: 22,
                    ),
                    title: 'Ngôn ngữ',
                  ...
                  SettingMenuItem(
                    leading: Image.asset(
                      Assets.icons.icArticlePerson.path,
                      width: 22,
                      height: 22,
                    ),
                    title: 'Đối tượng quan tâm',
                    onPressed: () {
                      context.router.push(const ListInterestScreen());
                    },
                  ),
                ],
              ),
            ...
            Center(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => context.router.replaceAll([const LoginScreen()]),
