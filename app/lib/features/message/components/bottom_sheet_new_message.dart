...
class BottomSheetNewMessage extends StatefulWidget {
  final Function(Person?) onSelected;

  const BottomSheetNewMessage({
    required this.onSelected,
    super.key,
  });

  @override
  State<BottomSheetNewMessage> createState() => _BottomSheetNewMessageState();
}

class _BottomSheetNewMessageState extends State<BottomSheetNewMessage> {
